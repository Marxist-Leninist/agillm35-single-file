#!/usr/bin/env python3
"""Single-file AGILLM3.5 lease coordinator for trusted or untrusted helpers.
...
class Handler(BaseHTTPRequestHandler):
    server_version = "AGILLM35LeaseHost/1"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="AGILLM3.5 single-file lease coordinator")
    sub = ap.add_subparsers(dest="cmd", required=True)
    common = argparse.ArgumentParser(add_help=False)
    common.add_argument("--spool", default=os.environ.get("AGILLM35_LEASE_SPOOL", "./agillm35_lease_spool"))
    common.add_argument("--secret-file", default=os.environ.get("AGILLM35_LEASE_SECRET_FILE", "./agillm35_lease_spool/lease_secret.txt"))
    common.add_argument("--public-base-url", default=os.environ.get("AGILLM35_PUBLIC_BASE_URL", ""))
